...
public class FileStore {
    ...
    private static java.io.File prepareBaseDir(java.io.File r4) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r4.exists()     // Catch:{ all -> 0x004b }
            if (r1 == 0) goto L_0x002e
            boolean r1 = r4.isDirectory()     // Catch:{ all -> 0x004b }
            if (r1 == 0) goto L_0x0011
            monitor-exit(r0)
            return r4
        L_0x0011:
            com.google.firebase.crashlytics.internal.Logger r1 = com.google.firebase.crashlytics.internal.Logger.getLogger()     // Catch:{ all -> 0x004b }
            ...
            r1.d(r2)     // Catch:{ all -> 0x004b }
            r4.delete()     // Catch:{ all -> 0x004b }
        L_0x002e:
            boolean r1 = r4.mkdirs()     // Catch:{ all -> 0x004b }
