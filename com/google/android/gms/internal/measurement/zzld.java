...
final class zzld {
    ...
    static int zzb(List<Integer> list) {
        ...
        if (list instanceof zzja) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzig.zzd(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zze(List<Integer> list) {
        ...
        if (list instanceof zzja) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzig.zzf(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzf(List<Long> list) {
        ...
        if (list instanceof zzjy) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzig.zzd(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzg(List<Integer> list) {
        ...
        if (list instanceof zzja) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzig.zzh(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzh(List<Long> list) {
        ...
        if (list instanceof zzjy) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzig.zzf(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzi(List<Integer> list) {
        ...
        if (list instanceof zzja) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzig.zzj(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzj(List<Long> list) {
        ...
        if (list instanceof zzjy) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzig.zzg(list.get(i3).longValue());
            }
        }
        return i;
    }
