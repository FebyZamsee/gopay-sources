...
public final class AFe1jSDK {
    ...
    public AFe1jSDK(Context context) {
    ...
    public static boolean values(Context context) {
        ...
        try {
            ...
            if (AFa1bSDK.values(context, new Intent("com.google.firebase.MESSAGING_EVENT", (Uri) null, context, FirebaseMessagingServiceListener.class))) {
                return true;
            }
            return false;
    ...
    public static void AFInAppEventParameterName(String str) {
        ...
        AFe1sSDK aFe1sSDK = new AFe1sSDK(str, values2);
        AFd1mSDK level = values2.getLevel();
        level.AFKeystoreWrapper.execute(new Runnable(aFe1sSDK) {
...
*/
    ...
    public final AFe1fSDK valueOf() {
        String string;
        String string2;
        String AFInAppEventParameterName = this.values.AFInAppEventParameterName("afUninstallToken", (String) null);
        long values2 = this.values.values("afUninstallToken_received_time", 0);
        boolean values3 = this.values.values("afUninstallToken_queued");
        ...
        if (values2 == 0 && (string = AppsFlyerProperties.getInstance().getString("afUninstallToken")) != null) {
            String[] split2 = string.split(",");
            if (split2.length >= 2) {
                try {
                    values2 = Long.parseLong(split2[split2.length - 2]);
                } catch (NumberFormatException unused) {
                }
            }
        }
        if (AFInAppEventParameterName != null) {
            return new AFe1fSDK(AFInAppEventParameterName, values2, values3);
        }
        return null;
    }
}
