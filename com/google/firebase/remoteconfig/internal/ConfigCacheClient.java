...
public class ConfigCacheClient {
    ...
    public /* synthetic */ Void m135lambda$put$0$comgooglefirebaseremoteconfiginternalConfigCacheClient(ConfigContainer configContainer) throws Exception {
    ...
    public /* synthetic */ Task m136lambda$put$1$comgooglefirebaseremoteconfiginternalConfigCacheClient(boolean z, ConfigContainer configContainer, Void voidR) throws Exception {
        if (z) {
    ...
    public static ConfigCacheClient getInstance(Executor executor2, ConfigStorageClient configStorageClient) {
