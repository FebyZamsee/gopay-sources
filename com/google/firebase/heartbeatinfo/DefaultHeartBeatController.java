...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    public /* synthetic */ Void m104lambda$registerHeartBeat$0$comgooglefirebaseheartbeatinfoDefaultHeartBeatController() throws Exception {
        synchronized (this) {
    ...
    public /* synthetic */ String m103lambda$getHeartBeatsHeader$1$comgooglefirebaseheartbeatinfoDefaultHeartBeatController() throws Exception {
    ...
    public HeartBeatInfo.HeartBeat getHeartBeatCode(String str) {
        synchronized (this) {
            ...
            if (heartBeatInfoStorage.shouldSendGlobalHeartBeat(currentTimeMillis)) {
                ...
                HeartBeatInfo.HeartBeat heartBeat = HeartBeatInfo.HeartBeat.GLOBAL;
                return heartBeat;
            }
            HeartBeatInfo.HeartBeat heartBeat2 = HeartBeatInfo.HeartBeat.NONE;
            return heartBeat2;
        }
    }
}
