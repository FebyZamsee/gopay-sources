...
class GmsRpc {
    ...
    public Task<?> subscribeToTopic(String str, String str2) {
        ...
        sb.append(str2);
        bundle.putString("gcm.topic", sb.toString());
        StringBuilder sb2 = new StringBuilder("/topics/");
        sb2.append(str2);
        return extractResponseWhenComplete(startRpc(str, sb2.toString(), bundle));
    }
    ...
    public /* synthetic */ String m118lambda$extractResponseWhenComplete$0$comgooglefirebasemessagingGmsRpc(Task task) throws Exception {
