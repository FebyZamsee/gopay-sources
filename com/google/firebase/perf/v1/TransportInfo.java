...
public final class TransportInfo extends GeneratedMessageLite<TransportInfo, Builder> implements TransportInfoOrBuilder {
    ...
    private static volatile getAnimationStyle<TransportInfo> PARSER;
    ...
    public enum DispatchDestination implements measureNullChild.read {
        SOURCE_UNKNOWN(0),
        FL_LEGACY_V1(1);
        
        private static final measureNullChild.asInterface<DispatchDestination> internalValueMap = null;
        private final int value;

        static {
            internalValueMap = new measureNullChild.asInterface<DispatchDestination>() {
        ...
        static final class DispatchDestinationVerifier implements measureNullChild.RemoteActionCompatParcelizer {
    ...
    public static TransportInfo parseFrom(ByteBuffer byteBuffer, getDividerWidth getdividerwidth) throws InvalidProtocolBufferException {
        return (TransportInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, getdividerwidth);
    }

    public static TransportInfo parseFrom(getBaseline getbaseline) throws InvalidProtocolBufferException {
        return (TransportInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getbaseline);
    }

    public static TransportInfo parseFrom(getBaseline getbaseline, getDividerWidth getdividerwidth) throws InvalidProtocolBufferException {
        return (TransportInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getbaseline, getdividerwidth);
    }
    ...
    public static TransportInfo parseFrom(byte[] bArr, getDividerWidth getdividerwidth) throws InvalidProtocolBufferException {
        return (TransportInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, getdividerwidth);
    }
    ...
    public static TransportInfo parseFrom(InputStream inputStream, getDividerWidth getdividerwidth) throws IOException {
        return (TransportInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, getdividerwidth);
    }
    ...
    public static TransportInfo parseDelimitedFrom(InputStream inputStream, getDividerWidth getdividerwidth) throws IOException {
        return (TransportInfo) parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, getdividerwidth);
    }

    public static TransportInfo parseFrom(getDividerDrawable getdividerdrawable) throws IOException {
        return (TransportInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getdividerdrawable);
    }

    public static TransportInfo parseFrom(getDividerDrawable getdividerdrawable, getDividerWidth getdividerwidth) throws IOException {
        return (TransportInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getdividerdrawable, getdividerwidth);
    }
    ...
    public static final class Builder extends GeneratedMessageLite.RemoteActionCompatParcelizer<TransportInfo, Builder> implements TransportInfoOrBuilder {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.AudioAttributesImplApi26Parcelizer audioAttributesImplApi26Parcelizer, Object obj, Object obj2) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[audioAttributesImplApi26Parcelizer.ordinal()]) {
            ...
            case 5:
                getAnimationStyle<TransportInfo> getanimationstyle2 = PARSER;
    ...
    public static getAnimationStyle<TransportInfo> parser() {
