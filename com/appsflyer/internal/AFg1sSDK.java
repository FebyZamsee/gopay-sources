...
public final class AFg1sSDK extends AFg1xSDK {
    public AFg1sSDK(Runnable runnable) {
        ...
        if (AFInAppEventParameterName(context)) {
            ...
            addObserver(new Observer() {
                /*  JADX ERROR: Method generation error
                    ...
                    */
                /*  JADX ERROR: Method generation error: Method args not loaded: com.appsflyer.internal.AFg1uSDK.2.update(java.util.Observable, java.lang.Object):void, class status: UNLOADED
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.appsflyer.internal.AFg1uSDK.2.update(java.util.Observable, java.lang.Object):void, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
...
*/
            ...
            build.startConnection(new GetAppsReferrerStateListener() {
                ...
                public final void onGetAppsReferrerSetupFinished(int i) {
                    AFg1sSDK.this.valueOf.put("api_ver", Long.valueOf(AFa1bSDK.AFKeystoreWrapper(context, "com.xiaomi.mipicks")));
                    AFg1sSDK.this.valueOf.put("api_ver_name", AFa1bSDK.values(context, "com.xiaomi.mipicks"));
                    if (i == -1) {
                        AFLogger.afWarnLog("XiaomiInstallReferrer SERVICE_DISCONNECTED");
                        AFg1sSDK.this.valueOf.put("response", "SERVICE_DISCONNECTED");
                    } else if (i == 0) {
                        AFg1sSDK aFg1sSDK = AFg1sSDK.this;
                        ...
                        try {
                            ...
                            if (getAppsReferrerClient.isReady()) {
                                ...
                                aFg1sSDK.valueOf.put("click_ts", Long.valueOf(installReferrer.getReferrerClickTimestampSeconds()));
                                aFg1sSDK.valueOf.put("install_begin_ts", Long.valueOf(installReferrer.getInstallBeginTimestampSeconds()));
                                HashMap hashMap = new HashMap();
                                hashMap.put("click_server_ts", Long.valueOf(installReferrer.getReferrerClickTimestampServerSeconds()));
                                hashMap.put("install_begin_server_ts", Long.valueOf(installReferrer.getInstallBeginTimestampServerSeconds()));
                                hashMap.put("install_version", installReferrer.getInstallVersion());
                                aFg1sSDK.valueOf.put("xiaomi_custom", hashMap);
                            } else {
                        ...
                        AFg1sSDK.this.valueOf.put("response", "SERVICE_UNAVAILABLE");
                        AFLogger.afWarnLog("XiaomiInstallReferrer not supported");
                    } else if (i == 2) {
                        AFLogger.afWarnLog("XiaomiInstallReferrer FEATURE_NOT_SUPPORTED");
                        AFg1sSDK.this.valueOf.put("response", "FEATURE_NOT_SUPPORTED");
                    } else if (i == 3) {
                        AFLogger.afWarnLog("XiaomiInstallReferrer DEVELOPER_ERROR");
                        AFg1sSDK.this.valueOf.put("response", "DEVELOPER_ERROR");
                    } else if (i != 4) {
                        AFLogger.afWarnLog("responseCode not found.");
                    } else {
                        AFLogger.afWarnLog("XiaomiInstallReferrer DEVELOPER_ERROR");
                        AFg1sSDK.this.valueOf.put("response", "PERMISSION_ERROR");
                    }
                    AFLogger.afDebugLog("Xiaomi Install Referrer collected locally");
                    AFg1sSDK.this.AFInAppEventType();
                    build.endConnection();
                }
            });
        }
