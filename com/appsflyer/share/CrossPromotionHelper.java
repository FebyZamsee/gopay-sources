...
public class CrossPromotionHelper {
    ...
    public static void logAndOpenStore(Context context, String str, String str2, Map<String, String> map) {
        LinkGenerator valueOf = valueOf(context, str, str2, map, String.format(AFg1kSDK.AFInAppEventParameterName, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFa1dSDK.valueOf().getHostName()}));
        if (AppsFlyerProperties.getInstance().getBoolean(AppsFlyerProperties.AF_WAITFOR_CUSTOMERID, false)) {
            ...
            AFKeystoreWrapper(valueOf.generateLink(), context, new AFg1hSDK(context));
        }
    }
    ...
    public static void logCrossPromoteImpression(Context context, String str, String str2, Map<String, String> map) {
        if (AppsFlyerProperties.getInstance().getBoolean(AppsFlyerProperties.AF_WAITFOR_CUSTOMERID, false)) {
            ...
            AFKeystoreWrapper(valueOf(context, str, str2, map, String.format(values, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFa1dSDK.valueOf().getHostName()})).generateLink(), context, (AFg1hSDK) null);
        }
    }

    private static void AFKeystoreWrapper(String str, Context context, AFg1hSDK aFg1hSDK) {
        AFa1dSDK valueOf = AFa1dSDK.valueOf();
        valueOf.AFInAppEventType(context);
        AFc1pSDK values2 = valueOf.values();
        AFd1aSDK aFd1aSDK = new AFd1aSDK(values2, str, aFg1hSDK);
        AFd1mSDK level = values2.getLevel();
        level.AFKeystoreWrapper.execute(new Runnable(aFd1aSDK) {
...
*/
    ...
    public static void setUrl(java.util.Map<java.lang.String, java.lang.String> r5) {
        ...
        L_0x0044:
            ...
            goto L_0x0008
        L_0x004b:
            com.appsflyer.internal.AFg1kSDK.AFInAppEventParameterName = r1
            goto L_0x0008
        L_0x004e:
            return
        */
