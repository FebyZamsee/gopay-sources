...
public final class GaugeMetadata extends GeneratedMessageLite<GaugeMetadata, Builder> implements GaugeMetadataOrBuilder {
    ...
    private static volatile getAnimationStyle<GaugeMetadata> PARSER = null;
    ...
    @Deprecated
    public final getBaseline getProcessNameBytes() {
        return getBaseline.asBinder(this.processName_);
    }
    ...
    /* access modifiers changed from: private */
    public void setProcessNameBytes(getBaseline getbaseline) {
        this.processName_ = getbaseline.AudioAttributesImplApi26Parcelizer();
        this.bitField0_ |= 1;
    }
    ...
    public static GaugeMetadata parseFrom(ByteBuffer byteBuffer, getDividerWidth getdividerwidth) throws InvalidProtocolBufferException {
        return (GaugeMetadata) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, getdividerwidth);
    }

    public static GaugeMetadata parseFrom(getBaseline getbaseline) throws InvalidProtocolBufferException {
        return (GaugeMetadata) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getbaseline);
    }

    public static GaugeMetadata parseFrom(getBaseline getbaseline, getDividerWidth getdividerwidth) throws InvalidProtocolBufferException {
        return (GaugeMetadata) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getbaseline, getdividerwidth);
    }
    ...
    public static GaugeMetadata parseFrom(byte[] bArr, getDividerWidth getdividerwidth) throws InvalidProtocolBufferException {
        return (GaugeMetadata) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, getdividerwidth);
    }
    ...
    public static GaugeMetadata parseFrom(InputStream inputStream, getDividerWidth getdividerwidth) throws IOException {
        return (GaugeMetadata) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, getdividerwidth);
    }
    ...
    public static GaugeMetadata parseDelimitedFrom(InputStream inputStream, getDividerWidth getdividerwidth) throws IOException {
        return (GaugeMetadata) parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, getdividerwidth);
    }

    public static GaugeMetadata parseFrom(getDividerDrawable getdividerdrawable) throws IOException {
        return (GaugeMetadata) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getdividerdrawable);
    }

    public static GaugeMetadata parseFrom(getDividerDrawable getdividerdrawable, getDividerWidth getdividerwidth) throws IOException {
        return (GaugeMetadata) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getdividerdrawable, getdividerwidth);
    }
    ...
    public static final class Builder extends GeneratedMessageLite.RemoteActionCompatParcelizer<GaugeMetadata, Builder> implements GaugeMetadataOrBuilder {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.AudioAttributesImplApi26Parcelizer audioAttributesImplApi26Parcelizer, Object obj, Object obj2) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[audioAttributesImplApi26Parcelizer.ordinal()]) {
            ...
            case 5:
                getAnimationStyle<GaugeMetadata> getanimationstyle2 = PARSER;
    ...
    public static getAnimationStyle<GaugeMetadata> parser() {
