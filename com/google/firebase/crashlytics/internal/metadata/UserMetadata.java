...
public class UserMetadata {
    ...
    public /* synthetic */ Object m93lambda$setUserId$0$comgooglefirebasecrashlyticsinternalmetadataUserMetadata() throws Exception {
    ...
    public boolean updateRolloutsState(List<RolloutAssignment> list) {
        synchronized (this.rolloutsState) {
            ...
            this.backgroundWorker.submit(new UserMetadata$$ExternalSyntheticLambda1(this, this.rolloutsState.getRolloutAssignmentList()));
            return true;
        }
    }
    ...
    public /* synthetic */ Object m94lambda$updateRolloutsState$1$comgooglefirebasecrashlyticsinternalmetadataUserMetadata(List list) throws Exception {
    ...
    class SerializeableKeysMap {
        ...
        public /* synthetic */ Void m95lambda$scheduleSerializationTaskIfNeeded$0$comgooglefirebasecrashlyticsinternalmetadataUserMetadata$SerializeableKeysMap() throws Exception {
