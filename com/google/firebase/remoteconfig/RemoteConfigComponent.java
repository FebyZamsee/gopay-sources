...
public class RemoteConfigComponent implements FirebaseRemoteConfigInterop {
    ...
    protected RemoteConfigComponent(Context context2, ScheduledExecutorService scheduledExecutorService, FirebaseApp firebaseApp2, FirebaseInstallationsApi firebaseInstallationsApi, FirebaseABTesting firebaseABTesting, Provider<AnalyticsConnector> provider, boolean z) {
        ...
        if (z) {
            Tasks.call(scheduledExecutorService, new RemoteConfigComponent$$ExternalSyntheticLambda2(this));
        }
    }
    ...
    public FirebaseRemoteConfig get(String str) {
        ...
        synchronized (this) {
            ...
            if (personalization != null) {
                ...
                getHandler.addListener(new RemoteConfigComponent$$ExternalSyntheticLambda1(personalization));
            }
            String str2 = str;
            firebaseRemoteConfig = get(this.firebaseApp, str2, this.firebaseInstallations, this.firebaseAbt, this.executor, cacheClient, cacheClient2, cacheClient3, getFetchHandler(str, cacheClient, metadataClient), getHandler, metadataClient, getRolloutsStateSubscriptionsHandler(cacheClient2, getHandler));
        }
        return firebaseRemoteConfig;
    }

    /* access modifiers changed from: package-private */
    public FirebaseRemoteConfig get(FirebaseApp firebaseApp2, String str, FirebaseInstallationsApi firebaseInstallationsApi, FirebaseABTesting firebaseABTesting, Executor executor2, ConfigCacheClient configCacheClient, ConfigCacheClient configCacheClient2, ConfigCacheClient configCacheClient3, ConfigFetchHandler configFetchHandler, ConfigGetParameterHandler configGetParameterHandler, ConfigMetadataClient configMetadataClient, RolloutsStateSubscriptionsHandler rolloutsStateSubscriptionsHandler) {
        FirebaseRemoteConfig firebaseRemoteConfig;
        String str2 = str;
        synchronized (this) {
    ...
    /* access modifiers changed from: package-private */
    public ConfigFetchHandler getFetchHandler(String str, ConfigCacheClient configCacheClient, ConfigMetadataClient configMetadataClient) {
        ...
        synchronized (this) {
            ...
            if (isPrimaryApp(this.firebaseApp)) {
                ...
                new RemoteConfigComponent$$ExternalSyntheticLambda0
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0011: CONSTRUCTOR  (r0v2 ? I:com.google.firebase.remoteconfig.RemoteConfigComponent$$ExternalSyntheticLambda0) =  call: com.google.firebase.remoteconfig.RemoteConfigComponent$$ExternalSyntheticLambda0.<init>():void type: CONSTRUCTOR in method: com.google.firebase.remoteconfig.RemoteConfigComponent.getFetchHandler(java.lang.String, com.google.firebase.remoteconfig.internal.ConfigCacheClient, com.google.firebase.remoteconfig.internal.ConfigMetadataClient):com.google.firebase.remoteconfig.internal.ConfigFetchHandler, dex: classes2.dex
                ...
                /*
                    this = this;
                    monitor-enter(r11)
                    com.google.firebase.installations.FirebaseInstallationsApi r1 = r11.firebaseInstallations     // Catch:{ all -> 0x0035 }
                    com.google.firebase.FirebaseApp r0 = r11.firebaseApp     // Catch:{ all -> 0x0035 }
                    boolean r0 = isPrimaryApp(r0)     // Catch:{ all -> 0x0035 }
                    if (r0 == 0) goto L_0x000f
                    com.google.firebase.inject.Provider<com.google.firebase.analytics.connector.AnalyticsConnector> r0 = r11.analyticsConnector     // Catch:{ all -> 0x0035 }
                L_0x000d:
                    r2 = r0
                    goto L_0x0015
                L_0x000f:
                    com.google.firebase.remoteconfig.RemoteConfigComponent$$ExternalSyntheticLambda0 r0 = new com.google.firebase.remoteconfig.RemoteConfigComponent$$ExternalSyntheticLambda0     // Catch:{ all -> 0x0035 }
                    r0.<init>()     // Catch:{ all -> 0x0035 }
                    goto L_0x000d
                L_0x0015:
                    java.util.concurrent.ScheduledExecutorService r3 = r11.executor     // Catch:{ all -> 0x0035 }
                    com.google.android.gms.common.util.Clock r4 = DEFAULT_CLOCK     // Catch:{ all -> 0x0035 }
                    java.util.Random r5 = DEFAULT_RANDOM     // Catch:{ all -> 0x0035 }
                    com.google.firebase.FirebaseApp r0 = r11.firebaseApp     // Catch:{ all -> 0x0035 }
                    com.google.firebase.remoteconfig.internal.ConfigFetchHandler r10 = new com.google.firebase.remoteconfig.internal.ConfigFetchHandler     // Catch:{ all -> 0x0035 }
                    com.google.firebase.FirebaseOptions r0 = r0.getOptions()     // Catch:{ all -> 0x0035 }
                    java.lang.String r0 = r0.getApiKey()     // Catch:{ all -> 0x0035 }
                    com.google.firebase.remoteconfig.internal.ConfigFetchHttpClient r7 = r11.getFrcBackendApiClient(r0, r12, r14)     // Catch:{ all -> 0x0035 }
                    java.util.Map<java.lang.String, java.lang.String> r9 = r11.customHeaders     // Catch:{ all -> 0x0035 }
                    r0 = r10
                    r6 = r13
                    r8 = r14
                    r0.<init>(r1, r2, r3, r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0035 }
                    monitor-exit(r11)
                    return r10
                L_0x0035:
                    r12 = move-exception
            ...
            /* access modifiers changed from: package-private */
            public ConfigRealtimeHandler getRealtime(FirebaseApp firebaseApp2, FirebaseInstallationsApi firebaseInstallationsApi, ConfigFetchHandler configFetchHandler, ConfigCacheClient configCacheClient, Context context2, String str, ConfigMetadataClient configMetadataClient) {
            ...
            public static void notifyRCInstances(boolean z) {
            ...
            static class GlobalBackgroundListener implements BackgroundDetector.BackgroundStateChangeListener {
                ...
                public static void ensureBackgroundListenerIsRegistered(Context context) {
                    ...
                    if (atomicReference.get() == null) {
                        ...
                        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, (Object) null, globalBackgroundListener)) {
