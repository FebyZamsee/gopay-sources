...
public class FirebaseRemoteConfigValueImpl implements FirebaseRemoteConfigValue {
    ...
    public long asLong() {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format("[Value: %s] cannot be converted to a %s.", new Object[]{asTrimmedString, "long"}), e);
        }
    }
    ...
    public double asDouble() {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format("[Value: %s] cannot be converted to a %s.", new Object[]{asTrimmedString, "double"}), e);
        }
    }
