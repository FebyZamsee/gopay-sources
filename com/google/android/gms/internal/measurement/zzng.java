...
public final class zzng implements zznh {
    ...
    static {
        ...
        zza = zza2.zza("measurement.ad_id_cache_time", (long) WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzg = zza2.zza("measurement.config.url_scheme", ProxyConfig.MATCH_HTTPS);
        ...
        zzu = zza2.zza("measurement.upload.realtime_upload_interval", (long) WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzad = zza2.zza("measurement.rb.attribution.uri_scheme", ProxyConfig.MATCH_HTTPS);
