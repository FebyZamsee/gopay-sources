...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final void zaL(TaskCompletionSource taskCompletionSource, int i, GoogleApi googleApi) {
        ...
        if (i != 0 && (zaa2 = zacd.zaa(this, i, googleApi.getApiKey())) != null) {
            taskCompletionSource.getTask().addOnCompleteListener((Executor) new zabk(this.zat), zaa2);
        }
    }
            ...
            case 5:
                ...
                if (zabq != null) {
                    if (connectionResult.getErrorCode() != 13) {
                        ...
                        StringBuilder sb = new StringBuilder("Error resolution was canceled by the user, original error message: ");
                    ...
                    StringBuilder sb2 = new StringBuilder("Could not find API instance ");
                    sb2.append(i2);
