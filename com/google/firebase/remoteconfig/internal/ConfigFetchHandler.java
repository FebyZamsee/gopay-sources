...
public class ConfigFetchHandler {
    ...
    public Task<FetchResponse> fetch(long j) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda1(this, j, hashMap));
    }
    ...
    public Task<FetchResponse> fetchNowWithTypeAndAttemptNumber(FetchType fetchType, int i) {
        ...
        sb.append(i);
        hashMap.put("X-Firebase-RC-Fetch-Type", sb.toString());
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda4(this, hashMap));
    }
    ...
    public /* synthetic */ Task m140lambda$fetchNowWithTypeAndAttemptNumber$1$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Map map, Task task) throws Exception {
        return m137lambda$fetch$0$comgooglefirebaseremoteconfiginternalConfigFetchHandler(task, 0, map);
    }

    /* access modifiers changed from: private */
    /* renamed from: fetchIfCacheExpiredAndNotThrottled */
    public Task<FetchResponse> m137lambda$fetch$0$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Task<ConfigContainer> task, long j, Map<String, String> map) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            task2 = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda2(this, id, token, date, map));
        }
        return task2.continueWithTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda3(this, date));
    }
    ...
    public /* synthetic */ Task m138lambda$fetchIfCacheExpiredAndNotThrottled$2$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Task task, Task task2, Date date, Map map, Task task3) throws Exception {
    ...
    public /* synthetic */ Task m139lambda$fetchIfCacheExpiredAndNotThrottled$3$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Date date, Task task) throws Exception {
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date, Map<String, String> map) {
        try {
            ...
            return this.fetchedConfigsCache.put(fetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda0(fetchFromBackend));
    ...
    private Long getFirstOpenTime() {
        ...
        return (Long) analyticsConnector2.getUserProperties(true).get("_fot");
    }
