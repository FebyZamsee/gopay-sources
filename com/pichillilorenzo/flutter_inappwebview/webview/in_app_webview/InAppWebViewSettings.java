...
public class InAppWebViewSettings implements ISettings<InAppWebViewInterface> {
    ...
    public Map<String, Object> getRealSettings(InAppWebViewInterface inAppWebViewInterface) {
        ...
        if (inAppWebViewInterface instanceof InAppWebView) {
            ...
            if (WebViewFeature.isFeatureSupported(WebViewFeature.SUPPRESS_ERROR_PAGE)) {
                map.put("disableDefaultErrorPage", Boolean.valueOf(WebSettingsCompat.willSuppressErrorPage(settings)));
            }
    ...
    private void setLayoutAlgorithm(String str) {
        if (str != null) {
            ...
            if (hashCode != -1986416409) {
                if (hashCode != 1055046617) {
                    if (hashCode == 1561826623 && str.equals("TEXT_AUTOSIZING")) {
                        c = 2;
                    }
                } else if (str.equals("NARROW_COLUMNS")) {
                    c = 1;
                }
    ...
    /* renamed from: com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewSettings$1  reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewSettings.AnonymousClass1.<clinit>():void");
        }
    }
