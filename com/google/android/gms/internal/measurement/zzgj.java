...
public final class zzgj {
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:33:0x00ce */
    ...
    private static com.google.android.gms.internal.measurement.zzgh zza(android.content.Context r11, java.io.File r12) {
        /*
            ...
            r1 = 0
            r2 = 1
            androidx.collection.SimpleArrayMap r3 = new androidx.collection.SimpleArrayMap     // Catch:{ all -> 0x00b3 }
        ...
        L_0x0071:
            ...
            androidx.collection.SimpleArrayMap r7 = new androidx.collection.SimpleArrayMap     // Catch:{ all -> 0x00b3 }
            r7.<init>()     // Catch:{ all -> 0x00b3 }
            r3.put(r5, r7)     // Catch:{ all -> 0x00b3 }
        L_0x007f:
            java.lang.Object r5 = r3.get(r5)     // Catch:{ all -> 0x00b3 }
            androidx.collection.SimpleArrayMap r5 = (androidx.collection.SimpleArrayMap) r5     // Catch:{ all -> 0x00b3 }
        ...
        L_0x00b8:
            r12 = move-exception
            java.lang.Class[] r0 = new java.lang.Class[r2]     // Catch:{ Exception -> 0x00ce }
            java.lang.Class<java.lang.Throwable> r3 = java.lang.Throwable.class
            r0[r1] = r3     // Catch:{ Exception -> 0x00ce }
            java.lang.Class<java.lang.Throwable> r3 = java.lang.Throwable.class
            java.lang.String r4 = "addSuppressed"
            java.lang.reflect.Method r0 = r3.getDeclaredMethod(r4, r0)     // Catch:{ Exception -> 0x00ce }
    ...
    public static class zza {
        private static volatile onDrawableLoadedFromResources<zzgh> zza;

        /* JADX WARNING: Removed duplicated region for block: B:17:0x0036  */
        /* JADX WARNING: Removed duplicated region for block: B:19:0x003c  */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static o.onDrawableLoadedFromResources<com.google.android.gms.internal.measurement.zzgh> zza(android.content.Context r4) {
            /*
                ...
                monitor-enter(r0)
                o.onDrawableLoadedFromResources<com.google.android.gms.internal.measurement.zzgh> r1 = zza     // Catch:{ all -> 0x0056 }
            ...
            L_0x0034:
                ...
                o.onDrawableLoadedFromResources r4 = o.onDrawableLoadedFromResources.read()     // Catch:{ all -> 0x0056 }
            L_0x003a:
                r1 = r4
                goto L_0x0052
            L_0x003c:
            ...
            L_0x004d:
                o.onDrawableLoadedFromResources r4 = com.google.android.gms.internal.measurement.zzgj.zza((android.content.Context) r4)     // Catch:{ all -> 0x0056 }
                goto L_0x003a
            L_0x0052:
            ...
            L_0x0056:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzgj.zza.zza(android.content.Context):o.onDrawableLoadedFromResources");
        }
    ...
    private static onDrawableLoadedFromResources<File> zzb(Context context) {
        try {
            File file = new File(context.getDir("phenotype_hermetic", 0), "overrides.txt");
            return file.exists() ? onDrawableLoadedFromResources.asBinder(file) : onDrawableLoadedFromResources.read();
        } catch (RuntimeException e) {
            Log.e("HermeticFileOverrides", "no data dir", e);
            return onDrawableLoadedFromResources.read();
        }
    }

    static onDrawableLoadedFromResources<zzgh> zza(Context context) {
        onDrawableLoadedFromResources<zzgh> ondrawableloadedfromresources;
        StrictMode.ThreadPolicy allowThreadDiskReads = StrictMode.allowThreadDiskReads();
        try {
            StrictMode.allowThreadDiskWrites();
            onDrawableLoadedFromResources<File> zzb = zzb(context);
            if (zzb.asInterface()) {
                ondrawableloadedfromresources = onDrawableLoadedFromResources.asBinder(zza(context, zzb.asBinder()));
            } else {
                ondrawableloadedfromresources = onDrawableLoadedFromResources.read();
            }
