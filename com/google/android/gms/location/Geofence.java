...
public interface Geofence {
    ...
    public static final class Builder {
        ...
        public final Builder setCircularRegion(double d, double d2, float f) {
            ...
            StringBuilder sb = new StringBuilder("Invalid latitude: ");
            sb.append(d);
            Preconditions.checkArgument(z2, sb.toString());
            boolean z3 = d2 >= -180.0d && d2 <= 180.0d;
            StringBuilder sb2 = new StringBuilder("Invalid longitude: ");
            sb2.append(d2);
            Preconditions.checkArgument(z3, sb2.toString());
            if (f > 0.0f) {
                z = true;
            }
            StringBuilder sb3 = new StringBuilder("Invalid radius: ");
            sb3.append(f);
