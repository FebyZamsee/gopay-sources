...
public class FirebaseApp {
    ...
    public static FirebaseApp initializeApp(Context context, FirebaseOptions firebaseOptions, String str) {
        ...
        synchronized (LOCK) {
            ...
            Preconditions.checkState(!map.containsKey(normalize), sb.toString());
    ...
    public /* synthetic */ DataCollectionConfigStorage m63lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
    ...
    public /* synthetic */ void m64lambda$new$1$comgooglefirebaseFirebaseApp(boolean z) {
        if (!z) {
