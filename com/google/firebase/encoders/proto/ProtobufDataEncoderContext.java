...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    /* access modifiers changed from: package-private */
    public final ObjectEncoderContext add(FieldDescriptor fieldDescriptor, double d, boolean z) throws IOException {
        if (z && d == 0.0d) {
            return this;
        }
    ...
    /* access modifiers changed from: package-private */
    public final ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
    ...
    /* access modifiers changed from: package-private */
    public final ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        Protobuf protobuf = getProtobuf(fieldDescriptor);
