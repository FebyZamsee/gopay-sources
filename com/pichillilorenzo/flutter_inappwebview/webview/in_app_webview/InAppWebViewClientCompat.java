...
public class InAppWebViewClientCompat extends WebViewClientCompat {
    ...
    public InAppWebViewClientCompat(InAppBrowserDelegate inAppBrowserDelegate2) {
    ...
    public boolean shouldOverrideUrlLoading(android.webkit.WebView r9, android.webkit.WebResourceRequest r10) {
        ...
        L_0x0068:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat.shouldOverrideUrlLoading(android.webkit.WebView, android.webkit.WebResourceRequest):boolean");
    }
    ...
    public void onShouldOverrideUrlLoading(InAppWebView inAppWebView, String str, String str2, Map<String, String> map, boolean z, boolean z2, boolean z3) {
        ...
        AnonymousClass1 r2 = new WebViewChannelDelegate.ShouldOverrideUrlLoadingCallback() {
            public boolean nonNullSuccess(NavigationActionPolicy navigationActionPolicy) {
                ...
                InAppWebViewClientCompat.this.allowShouldOverrideUrlLoading(inAppWebView2, str3, map2, z4);
                return false;
            }
    ...
    /* renamed from: com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat$7  reason: invalid class name */
    static /* synthetic */ class AnonymousClass7 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat.AnonymousClass7.<clinit>():void");
        }
    }
    ...
    public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceErrorCompat webResourceErrorCompat) {
        ...
        if (webResourceRequest.isForMainFrame()) {
            ...
            if (this.inAppBrowserDelegate != null) {
                this.inAppBrowserDelegate.didFailNavigation(webResourceRequest.getUrl().toString(), WebViewFeature.isFeatureSupported(WebViewFeature.WEB_RESOURCE_ERROR_GET_CODE) ? webResourceErrorCompat.getErrorCode() : -1, WebViewFeature.isFeatureSupported(WebViewFeature.WEB_RESOURCE_ERROR_GET_DESCRIPTION) ? webResourceErrorCompat.getDescription().toString() : "");
            }
        }
        if (inAppWebView.channelDelegate != null) {
    ...
    public void onReceivedHttpAuthRequest(android.webkit.WebView r16, android.webkit.HttpAuthHandler r17, java.lang.String r18, java.lang.String r19) {
        ...
        L_0x0056:
            ...
            com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat$2 r13 = new com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat$2
            r3 = r13
            r4 = r15
            r5 = r16
            r6 = r18
        ...
        L_0x008d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat.onReceivedHttpAuthRequest(android.webkit.WebView, android.webkit.HttpAuthHandler, java.lang.String, java.lang.String):void");
    }
    ...
    public void onReceivedClientCertRequest(final android.webkit.WebView r9, final android.webkit.ClientCertRequest r10) {
        ...
        L_0x001e:
            ...
            com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat$4 r2 = new com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat$4
            r2.<init>(r0, r10, r9)
        ...
        L_0x004a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat.onReceivedClientCertRequest(android.webkit.WebView, android.webkit.ClientCertRequest):void");
    }
    ...
    public void onSafeBrowsingHit(WebView webView, WebResourceRequest webResourceRequest, int i, SafeBrowsingResponseCompat safeBrowsingResponseCompat) {
        InAppWebView inAppWebView = (InAppWebView) webView;
        final SafeBrowsingResponseCompat safeBrowsingResponseCompat2 = safeBrowsingResponseCompat;
        ...
        AnonymousClass5 r1 = new WebViewChannelDelegate.SafeBrowsingHitCallback() {
                ...
                if (action != null) {
                    ...
                    if (intValue != 0) {
                        if (intValue != 1) {
                            ...
                            safeBrowsingResponseCompat2.showInterstitial(isReport);
                            return false;
                        } else if (!WebViewFeature.isFeatureSupported(WebViewFeature.SAFE_BROWSING_RESPONSE_PROCEED)) {
                            return true;
                        } else {
                            safeBrowsingResponseCompat2.proceed(isReport);
                            return false;
                        }
                    } else if (WebViewFeature.isFeatureSupported(WebViewFeature.SAFE_BROWSING_RESPONSE_BACK_TO_SAFETY)) {
                        safeBrowsingResponseCompat2.backToSafety(isReport);
                        return false;
                    }
                }
                return true;
            ...
            public void defaultBehaviour(SafeBrowsingResponse safeBrowsingResponse) {
                InAppWebViewClientCompat.super.onSafeBrowsingHit(webView2, webResourceRequest2, i2, safeBrowsingResponseCompat2);
            }
    ...
    public android.webkit.WebResourceResponse shouldInterceptRequest(android.webkit.WebView r10, com.pichillilorenzo.flutter_inappwebview.types.WebResourceRequestExt r11) {
        ...
        L_0x00f9:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.pichillilorenzo.flutter_inappwebview.webview.in_app_webview.InAppWebViewClientCompat.shouldInterceptRequest(android.webkit.WebView, com.pichillilorenzo.flutter_inappwebview.types.WebResourceRequestExt):android.webkit.WebResourceResponse");
    }
