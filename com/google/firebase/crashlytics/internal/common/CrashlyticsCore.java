...
public class CrashlyticsCore {
    ...
    public void logFatalException(Throwable th) {
        ...
        StringBuilder sb2 = new StringBuilder("Dropped on-demand fatal events: ");
        sb2.append(this.onDemandCounter.getDroppedOnDemandExceptions());
        logger2.d(sb2.toString());
        this.controller.setInternalKey("com.crashlytics.on-demand.recorded-exceptions", Integer.toString(this.onDemandCounter.getRecordedOnDemandExceptions()));
        this.controller.setInternalKey("com.crashlytics.on-demand.dropped-exceptions", Integer.toString(this.onDemandCounter.getDroppedOnDemandExceptions()));
