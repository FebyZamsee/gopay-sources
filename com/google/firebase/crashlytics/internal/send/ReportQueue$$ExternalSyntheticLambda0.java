...
import o.getThemedContext;

public final /* synthetic */ class ReportQueue$$ExternalSyntheticLambda0 implements getThemedContext {
    ...
    public final void onSchedule(Exception exc) {
        this.f$0.m102lambda$sendReport$1$comgooglefirebasecrashlyticsinternalsendReportQueue(this.f$1, this.f$2, this.f$3, exc);
    }
}
