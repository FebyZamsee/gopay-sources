...
public final /* synthetic */ class ConfigFetchHandler$$ExternalSyntheticLambda2 implements Continuation {
    ...
    public final Object then(Task task) {
        return this.f$0.m138lambda$fetchIfCacheExpiredAndNotThrottled$2$comgooglefirebaseremoteconfiginternalConfigFetchHandler(this.f$1, this.f$2, this.f$3, this.f$4, task);
    }
}
