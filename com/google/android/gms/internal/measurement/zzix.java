...
public abstract class zzix<MessageType extends zzix<MessageType, BuilderType>, BuilderType extends zzb<MessageType, BuilderType>> extends zzhd<MessageType, BuilderType> {
    ...
    protected static final class zza<T extends zzix<T, ?>> extends zzhh<T> {
        private final T zza;
    ...
    public static class zzb<MessageType extends zzix<MessageType, BuilderType>, BuilderType extends zzb<MessageType, BuilderType>> extends zzhf<MessageType, BuilderType> {
    ...
    public static final class zzf<ContainingType extends zzkj, Type> extends zzil<ContainingType, Type> {
    }
