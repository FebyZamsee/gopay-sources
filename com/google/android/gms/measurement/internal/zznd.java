...
public final class zznd extends zzic {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:39:0x00ca A[RETURN] */
    ...
    public final long zzm() {
        ...
        if (this.zzd.get() == 0) {
            synchronized (this.zzd) {
                nextLong = new Random(System.nanoTime() ^ zzb().currentTimeMillis()).nextLong();
                int i = this.zze + 1;
                this.zze = i;
                j = (long) i;
            }
    ...
    public final zzbg zza(String str, String str2, Bundle bundle, String str3, long j, boolean z, boolean z2) {
        ...
        if (zza(str2) == 0) {
            ...
            Bundle zza2 = zza(str, str2, bundle2, (List<String>) CollectionUtils.listOf("_o"), true);
            if (z) {
                zza2 = zzb(zza2);
            }
    ...
    public final boolean zza(String str, double d) {
        try {
            ...
            edit.putLong(Constants.TIMESTAMP, Double.doubleToRawLongBits(d));
            return edit.commit();
