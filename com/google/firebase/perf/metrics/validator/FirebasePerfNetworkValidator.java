...
final class FirebasePerfNetworkValidator extends PerfMetricValidator {
    ...
    public final boolean isValidPerfMetric() {
        ...
        if (resultUrl == null) {
            ...
            StringBuilder sb2 = new StringBuilder("URL fails allowlist rule: ");
            ...
            if (!isValidHttpMethod(this.networkMetric.hasHttpMethod() ? this.networkMetric.getHttpMethod() : null)) {
                ...
                StringBuilder sb3 = new StringBuilder("HTTP Method is null or invalid: ");
                ...
                StringBuilder sb4 = new StringBuilder("HTTP ResponseCode is a negative value:");
                ...
                StringBuilder sb5 = new StringBuilder("Request Payload is a negative value:");
                ...
                StringBuilder sb6 = new StringBuilder("Response Payload is a negative value:");
                ...
                StringBuilder sb7 = new StringBuilder("Start time of the request is null, or zero, or a negative value:");
                ...
                StringBuilder sb8 = new StringBuilder("Time to complete the request is a negative value:");
                ...
                StringBuilder sb9 = new StringBuilder("Time from the start of the request to the start of the response is null or a negative value:");
                ...
                StringBuilder sb10 = new StringBuilder("Time from the start of the request to the end of the response is null, negative or zero:");
    ...
    public final boolean isValidHttpMethod(NetworkRequestMetric.HttpMethod httpMethod) {
