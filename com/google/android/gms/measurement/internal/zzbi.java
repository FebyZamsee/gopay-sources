...
public final class zzbi {
    public static final zzfi<Long> zza;
    ...
    public static final zzfi<String> zzav = zza("measurement.rb.attribution.uri_scheme", ProxyConfig.MATCH_HTTPS, ProxyConfig.MATCH_HTTPS, zzcr.zza);
    ...
    public static final zzfi<String> zze = zza("measurement.config.url_scheme", ProxyConfig.MATCH_HTTPS, ProxyConfig.MATCH_HTTPS, zzcy.zza);
    ...
    static {
        ...
        zza = zza("measurement.ad_id_cache_time", valueOf, valueOf, zzbk.zza);
        zzu = zza("measurement.upload.realtime_upload_interval", valueOf, valueOf, zzbn.zza);
