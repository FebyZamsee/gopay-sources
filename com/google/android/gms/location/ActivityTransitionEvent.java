...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        int i = this.zza;
        StringBuilder sb2 = new StringBuilder("ActivityType ");
        sb2.append(i);
        sb.append(sb2.toString());
        sb.append(" ");
        int i2 = this.zzb;
        StringBuilder sb3 = new StringBuilder("TransitionType ");
        sb3.append(i2);
        sb.append(sb3.toString());
        sb.append(" ");
        long j = this.zzc;
        StringBuilder sb4 = new StringBuilder("ElapsedRealTimeNanos ");
        sb4.append(j);
